...
- [ ] Add video upload input method (MP4)
- [ ] Implement backend video frame extraction with FFmpeg
- [ ] Create frame-by-frame Roboflow analysis pipeline
- [ ] Add RTSP stream input for CCTV cameras
- [ ] Build video player with bounding box overlay
